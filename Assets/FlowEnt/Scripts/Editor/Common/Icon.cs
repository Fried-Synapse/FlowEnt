...
namespace FriedSynapse.FlowEnt.Editor
{
    ...
    public static class Icon
    {
        ...
        public static GUIContent Play = EditorGUIUtility.IconContent("PlayButton On@2x", "Play");
        public static GUIContent Pause = EditorGUIUtility.IconContent("PauseButton On@2x", "Pause");
        public static GUIContent NextFrame = EditorGUIUtility.IconContent("d_StepButton On@2x", "Next Frame");
