...
#pragma warning disable IDE0051, RCS1213
        public AbstractAnimation TweenTest => new Tween(1).For(Green).MoveLocalY(0.5f);
        // public Flow FlowTest => new Flow().Queue(new Tween(5).For(Green).MoveLocalY(0.5f)).Start();
        private void Start()
        {
            Echo.Build().Start();
            Tween.Build().Start();
